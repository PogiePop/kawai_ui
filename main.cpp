...
int main()
{
    ...
    Kawai::UIPanel* panel1 = new Kawai::UIPanel(400, 400, 400, 400, Kawai::color_black);
    ...
    Kawai::UIText* txt1 = new Kawai::UIText(400, 300, 100, 200, _window.GetFontResources()["default"], "HelloKawaiui", Kawai::MIDDLE_LEFT, 24);
    Kawai::UIButton* btn2 = new Kawai::UIButton(60, 60, 60,  40);
